...
GEO_SAMPLES = ["SRR13694213", "SRR13694215"] # ready ones 
# then do empty ones: 
# SRR13694203, SRR13694212, SRR13694214


# "SRR13694201""SRR13694213","SRR13694212", "SRR13694214", 
...
## GSM5077292
# SRR13694213 - just fastq file
# SRR13694212 - fastqc files and renamed (file size much smaller) 

## GSM5077293
# SRR13694214 - fastqc files and renamed (file size much smaller)  
# SRR13694215 - just fastq file  
...
rule all: 
    input: expand("/scratch/ell2yvj/projects/scRNA-seq/{geo_sample}/outs/filtered_feature_bc_matrix/barcodes.tsv.gz", geo_sample = GEO_SAMPLES), \
...
#input: "{geo_sample | sample}/outs/filtered_feature_bc_matrix/barcodes.tsv.gz"
#input: expand("/scratch/ell2yvj/projects/scRNA-seq/rawdata/{geo_sample}/{geo_sample}.fastq", sample = SAMPLES)

rule get_fastq: 
    output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}.fastq"
    threads: 1 
...
rule split_fastq: 
    input: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}.fastq"
    output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_1.fastq.gz", \
    "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_2.fastq.gz", \
    "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_3.fastq.gz"
    threads: 1
    resources: mem_mb=30000
...
rule fastqc: 
   ...
   input: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_I1_001.fastq.gz", \
   "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R1_001.fastq.gz", \
   "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R2_001.fastq.gz"
   output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_I1_001_fastqc.html", \
   "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R1_001_fastqc.html", \
   "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R2_001_fastqc.html"
   shell: """ 
   module load fastqc ; 
...
rule change_name_1:
    input: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_1.fastq.gz" # change to {geo_sample}_1.fastq.gz eventually
    output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_I1_001.fastq.gz"
    shell: """
    mv {input} {output}
    """
rule change_name_2:
    input: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_2.fastq.gz" # change to {geo_sample}_2.fastq.gz
    output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R1_001.fastq.gz"
    shell: """
    mv {input} {output}
    """
     #SampleName_S1_L001_R1_001.fastq.gz
rule change_name_3: 
    input: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_3.fastq.gz"
    output: "/scratch/ell2yvj/projects/scRNA-seq/GEO_datasets/{geo_sample}/{geo_sample}_S1_L001_R2_001.fastq.gz"
    shell: """
    mv {input} {output}
    """
